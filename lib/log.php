...
class OC_Log {
	...
	public static function write($app, $message, $level) {
		...
		if ($level >= $minLevel) {
			...
			// $entry = array('app' => $app, 'message' => $message, 'level' => $level, 'time' => $now);
			$fh = fopen($logFile, 'a');
	...
	public static function writeException($app, $functionName, $e) {
		OC_Log::write($app, $functionName . ' exception:' . $e -> getMessage(), OC_Log::ERROR);
	}
