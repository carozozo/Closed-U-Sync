...
class OC_L10N {
	...
	public static function findLanguage($app = null) {
		...
		$defaultLanguage = OC_Config::getValue('defaultLanguage', 'en', 'CONFIG_CUSTOM');
	...
	public static function findAvailableLanguagesForChinese($app = null) {
		$available = array('en');
		//english is always available
		$dir = self::findI18nDir($app);
		if (file_exists($dir)) {
