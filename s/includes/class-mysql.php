...
class ezSQL_mysql extends ezSQLcore {
	...
	function ezSQL_mysql($dbuser='', $dbpassword='', $dbname='', $dbhost='vsyncsql.ntua.edu.tw') {
		if ($dbuser && $dbname) {
	...
	function quick_connect($dbuser='', $dbpassword='', $dbname='', $dbhost='vsyncsql.ntua.edu.tw') {
		$return_val = false;
	...
	function connect($dbuser='', $dbpassword='', $dbhost='vsyncsql.ntua.edu.tw'){
