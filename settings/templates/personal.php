...
<?php if (OC_Config::getValue('allowChangePwd', '', 'CONFIG_SETTINGS_PERSONAL')){ ?>
<!-- CHANGE PASSROWD -->
...
<?php if (OC_Config::getValue('allowChangeEmail', '', 'CONFIG_SETTINGS_PERSONAL')){ ?>
<!-- CHANGE EMAIL -->
...
<?php if (OC_Config::getValue('allowChangeNickname', '', 'CONFIG_SETTINGS_PERSONAL')){ ?>
<!-- CHANGE NICKNAME -->
<form id="nicknameform">
    <fieldset class="personalblock">
        <label for="nickname"><strong><?php echo $l -> t('NickName'); ?></strong></label>
        <input type="text" name="nickname" id="nickname" value="<?php echo $_['nickname']; ?>" placeholder="<?php echo $l -> t('Your nickName'); ?>" /><span class="msg"></span><br />
        <em><?php echo $l -> t('Fill in nickname what you want'); ?></em>
    </fieldset>
</form>
<?php } ?>


<?php if (OC_Config::getValue('allowChangeLanguage', '', 'CONFIG_SETTINGS_PERSONAL')){ ?>
<!-- CHANGE LANGUAGE -->
<form>
	<fieldset class="personalblock">
...
<p class="personalblock">
        ...
        <br />
Service & extended functions provided by U-Sync. <?php echo OC_Helper::siteTitle();?>團隊
</p>