...
// calculate the disc space & decrease default soft link quota
...
$uid = OC_User::getUser();
$email = OC_User::getUserEmail($uid);
$nickname = OC_User::getUserNickname($uid);

$lang = OC_Preferences::getValue($uid, 'core', 'lang', 'zh_TW');
//$languageCodes = OC_L10N::findAvailableLanguages();
$languageCodes = OC_L10N::findAvailableLanguagesForChinese();
